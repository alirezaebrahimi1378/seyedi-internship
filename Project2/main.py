...
from spectral_signature import SpectralSignaturePlotter
...
def main():
    ...
    output_signiture_folder = os.path.join(dir, "SpectralSigniturePlot")
    ...
    color_map = {
        ...
        10: (0, 128, 0),  # Class 11 (dark green)
        11: (128, 128, 0),  # Class 12 (olive)
        12: (0, 0, 128),  # Class 13 (dark blue)
        13: (128, 0, 0),  # Class 14 (dark red)
        14: (64, 64, 64),  # Class 15 (dark gray)
        15: (255, 255, 255),  # Class 17 (white)
        16: (0, 255, 128),  # Class 18 (lime)
        17: (0, 128, 128),  # Class 19 (teal)
    }
    ...
    # Plot Classes Spectral Signiture
    plotter = SpectralSignaturePlotter(
        cls_path=output_image_path,
        sentinel2_raster_path=os.path.join(dir, "Sentinel2Images", "S2_medianComposite_2016-01-01_2017-01-01.tif"),
        output_folder=output_signiture_folder,
        sample_points=12,
        band_names=None,
        color_map=color_map
    )

    # Call the method that generates one plot per class
    plotter.plot_by_class()
